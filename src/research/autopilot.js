  ...
  for (let index = 0; index < limit; index += 1) {
    ...
    if (action === "finish-move") {
      ...
      const result = await finishMove({
        ...
        score: finishScore,
        costCompute: finishCostCompute,
        costDollars: finishCostDollars,
        ...
        paperFigure: finishPaperFigure,
        paperCaption: finishPaperCaption,
        paperLimitations: finishPaperLimitations,
        paperDiscussion: finishPaperDiscussion,
        publishCanvas: finishPublishCanvas,
        canvasImage: finishCanvasImage,
        canvasUrl: finishCanvasUrl,
        canvasTitle: finishCanvasTitle,
        canvasCaption: finishCanvasCaption,
        canvasSessionId: finishCanvasSessionId,
        canvasAgentId: finishCanvasAgentId,
        agentTownApi,
        fetchImpl,
      });
