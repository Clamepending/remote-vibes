...
const BUILDING_GUIDES_MARKER = "<!-- vibe-research:building-guides-protocol:v3 -->";
...
- For phase routing, start with \`vr-research-orchestrator tick <project-dir> --ask-human\`; it reads research phase, ACTIVE, QUEUE, LOG, doctor, and the latest result, then recommends the next runner / brief / judge action. Use \`--apply\` only for safe phase transitions such as exhausted \`experiment\` -> \`review\`.
